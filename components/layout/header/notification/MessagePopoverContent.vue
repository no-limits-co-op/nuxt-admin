...
<template>
  ...
  <div border-base flex-y-center pointer border-t-1>
    <div border-base flex-1 border-r-1 py-10px text-center>清空</div>
    <div border-base flex-1 border-r-1 py-10px text-center>全部已读</div>
